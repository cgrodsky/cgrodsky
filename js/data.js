...
(function () {
  ...
  const storeApps = [
    ...
    { id: "blender", name: "Blender", cat: "Multimedia", price: 0, builtin: "blender", desc: "A 3D viewport — switch primitives, recolor, and orbit the scene." },
    ...
    { id: "snip", name: "Snipping Tool", cat: "Utilities", price: 0, builtin: "snip", desc: "Snipping Tool — capture part of your screen to Photos." },
    ...
    { id: "clock", name: "Clock", cat: "Utilities", price: 0, builtin: "clock", desc: "Clock — a countdown timer, world clock, and stopwatch." },
