...
(function () {
  ...
  const LANG = { html: "HTML", css: "CSS", js: "JavaScript", json: "JSON", md: "Markdown", py: "Python", txt: "Plain Text", ts: "TypeScript", react: "React", cpp: "C++", nextjs: "Next.js", vue: "Vue", cs: "C#" };
  ...
  const FILE_ICON = {
    ...
    vue: `<img class="vs-fic vs-fic-img" src="assets/file_vue.png?v=1" alt="vue">`,
    cs: `<img class="vs-fic vs-fic-img" src="assets/file_cs.png?v=1" alt="c#">`,
  ...
  const LANGUAGES = [
    { id: "plaintext", name: "Plain Text", hl: "txt" }, { id: "chatagent", name: "Agent", hl: "txt" }, { id: "bat", name: "Batch", hl: "js" },
    { id: "bibtex", name: "BibTeX", hl: "txt" }, { id: "code-text-binary", name: "Binary", hl: "txt" }, { id: "c", name: "C", hl: "cpp" },
    { id: "cpp", name: "C++", hl: "cpp" }, { id: "csharp", name: "C#", hl: "cs" },
    { id: "clojure", name: "Clojure", hl: "js" }, { id: "snippets", name: "Code Snippets", hl: "json" }, { id: "coffeescript", name: "CoffeeScript", hl: "js" },
    { id: "css", name: "CSS", hl: "css" }, { id: "dockercompose", name: "Compose", hl: "txt" }, { id: "cuda-cpp", name: "CUDA C++", hl: "cpp" }, { id: "dart", name: "Dart", hl: "js" },
    { id: "diff", name: "Diff", hl: "txt" }, { id: "dockerfile", name: "Docker", hl: "js" }, { id: "dotenv", name: "Dotenv", hl: "txt" },
    { id: "fsharp", name: "F#", hl: "js" }, { id: "git-commit", name: "Git Commit Message", hl: "txt" }, { id: "git-rebase", name: "Git Rebase Message", hl: "txt" }, { id: "go", name: "Go", hl: "js" },
    { id: "groovy", name: "Groovy", hl: "js" }, { id: "handlebars", name: "Handlebars", hl: "html" }, { id: "hlsl", name: "HLSL", hl: "cpp" },
    { id: "html", name: "HTML", hl: "html" }, { id: "ignore", name: "Ignore", hl: "txt" },
    { id: "ini", name: "Ini", hl: "txt" }, { id: "instructions", name: "Instructions", hl: "md" }, { id: "java", name: "Java", hl: "js" },
    ...
    { id: "jsonc", name: "JSON with Comments", hl: "json" }, { id: "julia", name: "Julia", hl: "js" }, { id: "juliamarkdown", name: "Julia Markdown", hl: "md" },
